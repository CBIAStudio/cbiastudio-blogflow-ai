...
check_case(has($key_block, "if (\$posted_key !== '')"), 'only explicitly posted keys are saved');
check_case(has($key_block, "cbia_providers_save_settings"), 'nested provider key store remains synchronized');
