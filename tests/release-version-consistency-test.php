...
$readme_fixtures = [
    ['LF with the expected version', "# CBIAStudio BlogFlow with AI (WordPress) v2.2.2\n", true],
    ['CRLF with the expected version', "# CBIAStudio BlogFlow with AI (WordPress) v2.2.2\r\n", true],
    ['CRLF with an incorrect version', "# CBIAStudio BlogFlow with AI (WordPress) v2.2.1\r\n", false],
];
