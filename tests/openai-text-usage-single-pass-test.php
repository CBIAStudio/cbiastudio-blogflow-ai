...
ok_case(source_has($posts, 'below_critical_minimum'), 'initial article critically short');
ok_case(source_has($posts, "'result' => \$ok ? 'sufficient'"), 'expansion sufficient');
ok_case(source_has($posts, "'still_below_critical_minimum'"), 'expansion insufficient');
